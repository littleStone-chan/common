...
public class StringUtils {
     ...
     * @return
     */
    public static boolean isHasEquals(String target, String ... equals) {

        return !isNotEquelsOther(target,equals);
    }
     ...
     * @return
     */
    public static String join(String[] strArray,String symbol){
